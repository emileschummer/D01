...
xy_data = np.loadtxt(r'D:\Program files\Git\gitrepositories\D01\Data\B_J1\XY.dat')
X = xy_data[:, 0]  # X coordinates
Y = xy_data[:, 1]  # Y coordinates

# Step 2: Read velocity data from "velocity.dat" file
#velocity_data_path = os.path.join(current_dir, '..','Velocity','frame_1.dat')
velocity_data = np.loadtxt(r'D:\Program files\Git\gitrepositories\D01\Data\B_J1\Velocity\frame_1.dat')
